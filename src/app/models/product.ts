export class Product {
    ...
    constructor() {
        this.fullDescription = "Mais, vous savez, moi je ne crois pas qu'il y ait de bonne ou de mauvaise situation. " +
        ...
        this.shortDescription = this.fullDescription.slice(0,150) + '...';
    }
}
