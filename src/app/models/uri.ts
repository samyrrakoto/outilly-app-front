...
export class Uri {
  ...
  readonly PREREGISTER = 'secure/mangopay/user/card/preregister';
  readonly UPDATE_REGISTRATION = 'secure/mangopay/user/card/update-registration';
  readonly PREAUTH = 'secure/mangopay/preauth';
  path: string;
